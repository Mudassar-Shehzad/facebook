                ...
                <div className="h-[90vh] overflow-y-scroll bg-gray-100">
                    <div className="bg- flex flex-col  items-center pt-3 rounded-lg h-[80vh]">
                        ...
                        <div className="relative w-[70%]  flex justify-between">
                            <div className="absolute -bottom-3 -right-[4rem] laptop:right-0 mt-12 text-center ml-48 flex content-center w-full h-full flex-col ">
                                <h1 className="text-3xl font-bold">{friend[0].displayName}</h1>
                            </div>
                    ...
                    <div className="flex justify-center mt-4 p-2">
                        <div className="w-1/4 space-y-4">
                            <div className="p-4 bg-white rounded-md shadow">
                                ...
                                <p className="text-gray-600">{friend[0].userBio || 'User has no intro'}</p>
                            </div>
                                ...
                                {userPosts.length > 0 ? userPosts.map((post) => (
                                    <div key={post.id} className="bg-white mb-5 shadow rounded-md">
                                        ...
                                        <div className="border-t border-gray-200 p-4">
                                            ...
                                            <div className="mt-4 max-h-[15vh] overflow-scroll">
